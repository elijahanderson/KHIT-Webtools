    ...
    if request.method == 'POST':
        if form.validate_on_submit():
            ...
            try:
                ...
                error_msg = 'An unexpected error has occurred. If this error persists, contact Eli at eanderson@khitconsulting.com with this error message:', e
                render_template('cash_receipt.html', title='Cash Receipt', form=form, error_msg=error_msg)
